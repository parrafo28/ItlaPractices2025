                    ...
                    case "2":
                        {
                            ...
                            // var contactsFiltered = contacts.Where(p => p.Name.ToLower().Contains(name.ToLower()) || p.LastName.ToLower().Contains(name.ToLower()) || p.Email.ToLower().Contains(name.ToLower()));
                            ...
                            //foreach (var item in favoritesAndgreaterAge2)
                            //{
                            //    favoritesCotnacts.Add(new ContactFavorites
                            //    {
                            //        BestFriendName = item.Name + " " + item.LastName,
                            //    });
                            //}
